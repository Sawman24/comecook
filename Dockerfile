...
CMD ["sh", "-c", "exec gunicorn --bind 0.0.0.0:${PORT:-5050} --workers 2 --threads 16 --worker-class gthread --backlog 2048 --worker-tmp-dir /dev/shm --timeout 30 --access-logfile - --error-logfile - app:app"]
